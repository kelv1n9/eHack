...
void setup()
{
  ...
  ELECHOUSE_cc1101.setRxBW(200.0);    // Set the Receive Bandwidth in kHz. Value from 58.03 to 812.50. Default is 812.50 kHz. (narrower = better sensitivity for ASK)
  ...
  ELECHOUSE_cc1101.setDRate(5);    // Set the Data Rate in kBaud. Value from 0.02 to 1621.83. Default is 99.97 kBaud! (match typical RCSwitch ASK ~4.8 kBaud)
  /************************/
