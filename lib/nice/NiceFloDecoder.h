...
extern volatile uint32_t barrierCodeMain;
extern volatile uint8_t barrierBit;
extern volatile uint8_t barrierProtocol;
// Переменная barrierCodeAdd из твоего кода. Если для Nice она не нужна,
// ее можно не объявлять, но для унификации оставим.
extern volatile uint32_t barrierCodeAdd;
